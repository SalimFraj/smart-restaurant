    ...
    <div className="container mx-auto px-4 py-6 sm:py-8">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-6 mb-6 sm:mb-8">
        <div className="stat bg-base-100 shadow-xl rounded-lg p-3 sm:p-6">
          ...
          <div className="stat-value text-primary text-xl sm:text-3xl">${stats.revenue.toFixed(2)}</div>
        ...
        <div className="stat bg-base-100 shadow-xl rounded-lg p-3 sm:p-6">
          ...
          <div className="stat-value text-secondary text-xl sm:text-3xl">{stats.orderCount}</div>
          <div className="stat-desc text-xs hidden sm:block">Period: {period}</div>
        </div>
      </div>
