                    ...
                    {isOpen && (
                        <>
                            ...
                            <motion.div
                                ...
                                className="fixed inset-x-0 bottom-0 sm:inset-auto sm:absolute sm:right-0 sm:mt-2 w-full sm:w-[380px] md:w-[420px] bg-base-100 rounded-t-2xl sm:rounded-2xl shadow-2xl z-50 max-h-[85vh] sm:max-h-[600px] flex flex-col border-t sm:border border-base-300/50 overflow-hidden"
                            >
                                <div className="bg-gradient-to-r from-primary to-secondary p-4 sm:p-5 text-primary-content">
                                            ...
                                            <div className="flex gap-1">
                                                {unreadCount > 0 && (
                                                    <motion.button
                                                        ...
                                                        className="btn btn-xs btn-ghost text-primary-content hover:bg-white/20"
                                                    >
                                        ...
                                        {categories.map((cat) => (
                                            ...
                                            >
                                                ...
                                                {cat.key === 'unread' && unreadCount > 0 && (
                                                    <span className="ml-0.5 badge badge-xs bg-primary text-primary-content">
                                                        {unreadCount}
                                                    </span>
                                                )}
                                            </motion.button>
                                                ...
                                                {filteredNotifications.map((notification, index) => {
                                                    ...
                                                    return (
                                                        <motion.div
                                                            ...
                                                            className={`p-3 sm:p-4 hover:bg-base-200/70 cursor-pointer transition-all group relative ${!notification.read ? 'bg-primary/5' : ''}`}
                                                            onClick={() => handleNotificationClick(notification)}
                                                        >
                                                            {!notification.read && (
                                                                <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-10 bg-gradient-to-b from-primary to-secondary rounded-r-full" />
                                                            )}

                                                            <div className="flex gap-3 ml-2">
                                                                <div className={`flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl ${iconData.bg} flex items-center justify-center`}>
                                                                    <span className="text-xl sm:text-2xl">{iconData.emoji}</span>
                                                                </div>
                                                                ...
                                                                <div className="flex-1 min-w-0">
                                                                    ...
                                                                    <p className="text-xs sm:text-sm text-base-content/70 line-clamp-2 mb-1">
